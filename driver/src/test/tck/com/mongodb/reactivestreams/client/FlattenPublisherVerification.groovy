...
class FlattenPublisherVerification extends PublisherVerification<List<Integer>> {
    ...
    Publisher<String> createPublisher(long elements) {
        ...
        new AsyncIterablePublisher<List<Integer>>(new Iterable<List<Integer>>() {
            @Override
            Iterator<List<Integer>> iterator() {
                new Iterator<List<Integer>>() {
                    private int at = 0
